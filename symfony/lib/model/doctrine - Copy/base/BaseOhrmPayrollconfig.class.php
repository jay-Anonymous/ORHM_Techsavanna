 ...
 * @method OhrmPayrollconfig setOtherRelief()       Sets the current record's "other_relief" value
   * @method OhrmPayrollconfig setDailyRate()       Sets the current record's "other_relief" value
   * @method OhrmPayrollconfig setHourlyRate()       Sets the current record's "other_relief" value
 * 
 * @package    orangehrm
