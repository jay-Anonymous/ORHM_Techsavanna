 ...
 * @method string      getCalculationType()         Returns the current record's "name" value
 *  @method decimal     getMonthlyRate()         Returns the current record's "name" value
 * @method decimal     getAnnualRate()         Returns the current record's "name" value
 ...
 * @method OhrmBenefits setTaxable()      Sets the current record's "taxable" value
  * @method OhrmBenefits setCalculationType()      Sets the current record's "taxable" value
  * @method OhrmBenefits setMonthlyRate()      Sets the current record's "taxable" value
