 ...
 * @method string                getPaymentmethod() Returns the current record's "paymentmethod" value
 ...
 * @method HsHrEmpdefaultpaymode setPaymentmethod() Sets the current record's "paymentmethod" value
 * 
 * @package    orangehrm
